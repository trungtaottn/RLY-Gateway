...
- [x] Docs/RTM/AT: FR-028 / SR-F-032 added; AT-169–AT-179 added (checked against final merged dev max FR-027 / SR-F-031 / AT-168 from #93/#126); SPEC §6.10 + canary acceptance; ARCHITECTURE claims/evidence section; protocol-compatibility claims section; project-decisions decision; RTM Phase 122 evidence rows; TASKLIST entry. Evidence: `tests/unit/canary-claim.test.ts`, `tests/unit/canary-evidence.test.ts`, `tests/unit/canary-matrix.test.ts`, `tests/unit/canary-projection.test.ts`, `tests/unit/cli-canary.test.ts`, `tests/unit/model-registry.test.ts`, `tests/unit/cli-diagnostics.test.ts`, `tests/privacy/canary.test.ts`; `pnpm lint`, `pnpm typecheck`, `pnpm test` (631 passed / 22 skipped), `pnpm test:privacy` (27 passed; privacy scan 379 files), `pnpm build`, `git diff --check` all green (see PR).
